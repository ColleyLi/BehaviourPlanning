...
#include "modules/planning_btree/math/curve_math.h"
#include "modules/planning_btree/math/smoothing_spline/osqp_spline_2d_solver.h"
...
bool QpSplineReferenceLineSmoother::AddConstraint() {
  ...
  if (FLAGS_btree_enable_reference_line_stitching &&
