...
namespace planning_btree {
  ...
  // BTreeNodeState PathGenerator::Execute(BTreeFrame* frame, ReferenceLineInfo* reference_line_info)
  // {
  ...
  //   double dt = 0.1;
  //   double ds = 10;
  //   double planning_btree_time_horizon = 3.0;
  //   for (double t = 0; t < planning_btree_time_horizon; t+=dt)
  //   {
